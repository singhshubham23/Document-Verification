...
//     name: '', email: '', phone: '', password: '', role: 'verifier',
//   });
...
//               <Input label="Full Name" placeholder="Shubham Kumar" value={form.name}
//                 onChange={(e) => setForm({ ...form, name: e.target.value })} required />

//               <Input label="Email" type="email" placeholder="you@example.com" value={form.email}
//                 onChange={(e) => setForm({ ...form, email: e.target.value })} required />

//               <Input label="Phone" type="tel" placeholder="+91 XXXXX XXXXX" value={form.phone}
...
//                 <p className="text-slate-500 text-sm">Enter the 6-digit OTP sent to <span className="text-jade-400">{form.email}</span></p>
//               </div>
...
//                 Didn't receive it?{' '}
//                 <button type="button" className="text-jade-400 hover:text-jade-300 font-display font-medium">
//                   Resend OTP
//                 </button>
//               </p>
//             </form>
        ...
        <div className="glass rounded-2xl p-8">
          {step === 'form' ? (
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <Input label="Full Name" placeholder="Shubham Kumar" required {...f('name')} />
              ...
              {form.role === 'institution' && (
                <div className="space-y-1.5 animate-fade-up">
                  ...
                  <input
                    ...
                    placeholder="e.g. Rajiv Gandhi Technical University"
